...
extension Delta {
    ...
    @inlinable public func apply(to initialValue: inout Value, _ tranceform: (Value, Value) throws -> Value) rethrows {
...
extension Delta where Value: AdditiveArithmetic {
    ...
    @inlinable public func apply(to initialValue: inout Value) {
        apply(to: &initialValue, +)
    }
    
    @inlinable public static func += (_ initialValue: inout Value, delta: Delta<Value>) {
        delta.apply(to: &initialValue)
    }
}
